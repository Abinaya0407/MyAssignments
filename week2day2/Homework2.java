...
public class Homework2 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//span[@class='requiredField']/following::input[@id='createLeadForm_firstName']")).sendKeys("Abi");
		driver.findElement(By.xpath("//span[@class='requiredField']/following::input[@id='createLeadForm_lastName']")).sendKeys("Tamil");
